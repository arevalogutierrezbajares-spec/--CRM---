...
type: failure-mode
system: crm
title: Email sync cron 500s
summary: email-sync cron returns 500; missing tables or migration drift
symptoms: email sync, postmark, schema_migrations
---

# Email sync cron 500s

## Symptoms
email sync, postmark, schema_migrations
