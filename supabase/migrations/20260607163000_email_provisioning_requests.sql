...
alter table public.email_provisioning_requests enable row level security;

DROP POLICY IF EXISTS email_provisioning_requests_admin_select ON public.email_provisioning_requests;
CREATE POLICY email_provisioning_requests_admin_select ON public.email_provisioning_requests
  FOR SELECT TO authenticated
  USING (public.is_workspace_admin(workspace_id));

DROP POLICY IF EXISTS email_provisioning_requests_admin_mutate ON public.email_provisioning_requests;
CREATE POLICY email_provisioning_requests_admin_mutate ON public.email_provisioning_requests
